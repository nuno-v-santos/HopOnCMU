...
export default class Edit extends React.Component {
    ...
    onPress() {
        ...
        if (value) { // if validation fails, value will be null
            fetch(INFO.url + "/api/" + this.props.class.name.toLowerCase() + "/" + this.props.values.id, {
                method: 'PUT',
                headers: {
    ...
    render() {
        ...
        return <View>
            <Toolbar style={{marginBottom: 20}} title={"Edit " + this.props.class.name} hasLeftButton={true}
